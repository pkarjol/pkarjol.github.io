...
> **Result on T. Zhang's bound** - If $\xhat_s$ is the outout of OMP after $s=\Theta\roundbrack{\kappas{s}\log\kappa_s \sstar}$ iterations, then with high probability  
> $$
> \begin{gather}
...
> **After modification on T. Zhang's bound** - If $\xhat_s$ is the outout of OMP after $s=\Theta\roundbrack{\kappas{s}\log\kappa_s \sstar}$ iterations, then with high probability  
> $$
> \begin{gather}
