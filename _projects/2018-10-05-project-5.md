...
> $$
> \begin{equation}
> \inv{n}\esqnorm{\A(\x_s-\xbar)} \lesssim \inv{n}\sigma^2\sstar\kappas{s+\sstar}^2\log\kappa_{s+\sstar}\log d
> \end{equation}
> $$
...
> $$
> \begin{equation}
> \inv{n}\esqnorm{\A(\x_s-\xbar)} \lesssim \inv{n}\sigma^2\sstar\kappas{s+\sstar}\log\kappa_{s+\sstar}\log d
> \end{equation}
> $$
...
We note that the $\gamma$ in this result is similar to the mutual incoherence condition and is not required to be bounded by a universal constant and can be very large.
