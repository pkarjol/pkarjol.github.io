...
where $$\x\in\Rd{d}$$ and $$\sstar< d $$, the ambient dimension and $$\lznorm{\cdot}$$ is the $$\ell_0$$ norm that denotes the number of non-zero elements of its arguments.

Our focus has been on the linear version of the problem
