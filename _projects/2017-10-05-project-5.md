...
\$$
(1-\delta_s)\esqnorm{\vvec} \leq \esqnorm{\A\vvec} \leq (1+\delta_s)\esqnorm{\vvec} \qquad \forall\ \vvec \in\Rd{d} \text{ s.t. } \lznorm{\vvec} \leq s.\\
$$
