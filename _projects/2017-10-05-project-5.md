...
We construct a parameterized matrix $$\M^\brackeps$$ by $$0\leq \epsilon\leq 1$$ such that all the $$\sstar$$ columns of the true support $$\Sstar$$ are orthogonal and the remaining columns are linear combinations of the mean of the true features and vectors orthogonal to their subspace. Precisely,
